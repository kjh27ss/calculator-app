...
const MyKeyboard = () => {
  ...
  const firstNumberDisplay = () => {
    if(result !== null){
        return <Text style = {result < 99999 ? [Styles.screenFirstNumber, {color : myColor.result}] : [Styles.screenFirstNumber, {color: myColor.result, fontSize : 50}]}>
        {result}
        </Text>
    }
  ...
  return (
    <View Style={Styles.viewBottom}>
        ...
        <Text style={Styles.screenSecondNumber}>{secondNumber}<Text style={{color:"purple", fontSize:50, fontWeight:'500'}}>{operation}</Text></Text>
        ...
        <View style={Styles.row}>
            ...
            <Buttons title = "x" isBlue onPress={()=>handleOperationPress("x")} />
        </View>
        <View style={Styles.row}>
